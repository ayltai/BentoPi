...
export { sensorService, useGetHumidityQuery, useGetTemperatureQuery, } from './sensorService';
...
export { unsplashService, useGetRandomPhotoQuery, } from './unsplashService';
export { useGetWeatherQuery, weatherService, } from './weatherService';
